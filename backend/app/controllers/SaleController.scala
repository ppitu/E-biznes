...
class SaleController (cc: ControllerComponents, actorSystem: ActorSystem)(implicit exec: ExecutionContext) extends AbstractController(cc){
  def getSale: Action[AnyContent] = Action {
    Ok("Gets all Sales")
  }
